...
import { ArrowRightIcon, CreditCardIcon, LoaderIcon } from "lucide-react";
...
const billingReturnUrl = webUrls.appPath("/dashboard");

export function BillingSettings({ onBack }: { onBack?: () => void }) {
